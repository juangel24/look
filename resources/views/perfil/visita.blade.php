      ...
      <div class="container perfil">
              ...
              <div class="media" id="divmedia">
                ...
                <img class="d-flex mr-3" id="fotodeperfil" src="{{ asset($usuario[0]->imagen) }}"   style="height:100px;width:100px;border-radius:60%;">
                  ...
                  <div class="media-body " id="mediaperfil">
                    ...
                    <button class="btn btn-primary" id="idseguidor" value="{{ $usuario[0]->id }}">Seguir</button>  
                    @else
                    <button class="" id="idseguidores" value="{{ $usuario[0]->id }}"><i class="fas fa-check"></i></button>  
                    @endif
        ...
        {{-- INICIO DE VALIDACIÓN Y CREACION DE CARD DE PUBLICACION --}}
                                ...
                                <div class="col-md-7 scrollable border border-default" id="div-comments-posts" data-postid="{{ $item->id }}">
                                  <div class="d-flex justify-content-between align-items-center border-bottom border-default p-3 comment-header">
                                    <div class="d-flex flex-row">
                                        ...
                                        <h5 class="ml-2 mb-0 align-self-center">{{ $usuario[0]->usuario }}</h5>
          ...
          <div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong>Hola {{ $usuario[0]->usuario }}</strong>No has hecho ninguna publicaión x-x
